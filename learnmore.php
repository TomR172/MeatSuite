...
<?php 
    $tab = $_GET['tab'];
    if ($tab==1) : ?>
        <h3 class="title">CLAIMS AND DEFINITIONS<h3>
    ...
    <?php elseif ($tab==2) : ?>
        <h3 class="title">COMMON CATTLE BREEDS</h3>
        <div class="marginize">
    ...
    <?php elseif ($tab==3) : ?>
        <h3 class="title">DESCRIPTIONS OF TYPES OF LIVESTOCK FEEDS</h3>
        <div class="marginize">
    ...
    <?php elseif ($tab==5) : ?>
        <h3 class="title">USDA AND NYS REGULATIONS</h3>
